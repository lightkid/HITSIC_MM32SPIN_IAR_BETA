...
#define OLED_DC_H  GPIO_SetBits(OLED_DC);  
#define OLED_DC_L  GPIO_ResetBits(OLED_DC);

#define OLED_RST_H GPIO_SetBits(OLED_RST);
#define OLED_RST_L GPIO_ResetBits(OLED_RST); 

#define OLED_DI_H  GPIO_SetBits(OLED_DI); 
#define OLED_DI_L  GPIO_ResetBits(OLED_DI); 

#define OLED_CK_H  GPIO_SetBits(OLED_CK); 
#define OLED_CK_L  GPIO_ResetBits(OLED_CK);

#define OLED_CS_H  GPIO_SetBits(OLED_CS);      /*!< CS管脚 */
#define OLED_CS_L  GPIO_ResetBits(OLED_CS);     /*!< CS管脚 */
...
void OLED_P6x8Str(unsigned char x,unsigned char y, char ch[]);//一共8行，y0~7x0~127
