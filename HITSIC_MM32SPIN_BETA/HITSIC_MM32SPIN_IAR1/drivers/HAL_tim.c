...
void TIM_OCStructInit(TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIM_OCInitStruct->TIM_OutputState = TIM_OutputState_Disable;//en
    TIM_OCInitStruct->TIM_OutputNState = TIM_OutputNState_Disable;
    TIM_OCInitStruct->TIM_Pulse = 0x0000000;//脉宽计数器设置的值，跟占空比有关
    TIM_OCInitStruct->TIM_OCPolarity = TIM_OCPolarity_High;//阈值以上高电平
